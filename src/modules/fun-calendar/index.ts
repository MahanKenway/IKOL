...
const RANDOM_FACTS = [
  ...
  '☀️ The surface of the Sun is about 5,500°C (9,932°F).',
...
function createFunCalendarModule(): IkolModule {
  return {
    name: 'fun-calendar',
    featureFlag: 'funCalendar',
    version: '2.0.0',
    register(composer: Composer<Context>, env: Env, flags: FeatureFlags) {
      ...
      composer.command('randomfact', async (ctx) => {
...
registerModule(createFunCalendarModule());
