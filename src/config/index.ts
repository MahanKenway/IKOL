...
export const CONFIG = {
  ...
  APIS: {
    ...
    // Gaming
    EPIC_GAMES: 'https://store-site-backend-static-ipv4.ak.epicgames.com',
    ...
    // Download (Cobalt API - self-hosted)
...
export function getConfig(env: Env) {
  return {
    ...
    APIS: {
      ...CONFIG.APIS,
      COBALT: env.COBALT_API_URL || CONFIG.APIS.COBALT,
      NASA: env.NASA_API_KEY 
        ? `${CONFIG.APIS.NASA}?api_key=${env.NASA_API_KEY}`
        : `${CONFIG.APIS.NASA}?api_key=DEMO_KEY`,
    },
  };
}
